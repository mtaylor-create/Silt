...
Please visit the Silt project description at http://golancourses.net/2013/projects/silt-a-sifteo-image-explorer/
...
I'm still working out a few bugs, including how to export the processing sketch into an application that will still allow gviewer.command to run, so pardon the mess.  Expect more features to come, including support for larger images.  If you're trying to use this as-is, here is an important note about setting up the software:
